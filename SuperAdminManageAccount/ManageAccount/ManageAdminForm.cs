...
namespace Authenti_Gate.SuperAdminManageAccount.ManageAccount
{
    public partial class ManageAdminForm : Form
    {
        ...
        wrongPassword wrong = new wrongPassword();
        private void roundedButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string cm = "Select Password from account_table WHERE Password=@Password AND Number=2";
                ...
                if (count == 1)
                {
                    ...
                    {
                        string cmm = "UPDATE account_table SET Password='" + tbNewPass.Text + "' WHERE Number = 2";
                ...
                {
                    //shows a dialog that the user inputs a incorrect password
                    using (updatePasswordMsgBox updateError = new updatePasswordMsgBox())
                    {
                        DialogResult result = updateError.ShowDialog();
                    }
