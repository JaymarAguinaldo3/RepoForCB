...
{
    public partial class deleteMsgBox : Form
    {
        private int _cornerRadius = 40;
        private Color _borderColor = Color.DarkRed; // Set your border color
        private int _borderThickness = 1; // Se
        public deleteMsgBox()
        {
            InitializeComponent();
            ...
            lblMessage.Text = "Delete this record?";
